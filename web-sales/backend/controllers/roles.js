...
//   */
  exports.edit = function(req, res) {
    Roles.findOne({ _id: req.params.id }).exec(function(err, product) {
  ...
  exports.delete = function(req, res) {
    ...
    Roles.remove({ _id: req.params.id }, function(err) {
          if (err) { console.log('Error: ', err); return; }
